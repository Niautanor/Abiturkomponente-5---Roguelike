...
bool CItemTypeList::InitTypes()
{
	TypeList.Push(new CItemType("", ""));//ITL_NONE

	TypeList.Push(new CSeedType(SIED_PLUMPHELMET, "Plump Samen", "Der Samen eines bei Zwergen sehr beliebten Nahrungsmittels"));//ITL_PLUMPHELMET_SEED
	...
	TypeList.Push(new CSeedType(SIED_BANELING, "Baneling Samen", "Der Samen einer Pflanze, die hin und wieder explodiert"));//ITL_BANELING_SEED
